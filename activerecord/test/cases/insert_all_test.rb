...
class InsertAllTest < ActiveRecord::TestCase
  ...
  def test_insert_all_with_array_of_model_does_not_raise_an_error_when_primary_key_type_is_not_serial
    ...
    assert_difference "UuidMessage.count", +1 do
      UuidMessage.insert_all [
        UuidMessage.new({uuid: uuid}),
      ]
    end

    assert_equal UuidMessage.last.uuid, uuid
  end
